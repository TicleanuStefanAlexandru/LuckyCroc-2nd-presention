...
public class CasinoFloorEntranceManager : MonoBehaviour
{
    ...
    public void EnterVultureHollows()
    {
        int requiredMoney = floorRequirements["The Vulture Hollows"];
        if (daveStats.money < requiredMoney)
        {
            ShowFeedback($"Security: You need ₵{requiredMoney:N0} to enter The Vulture Hollows.");
            return;
        }
        EnterFloor("The Vulture Hollows", "The Vulture Hollows");
    }
